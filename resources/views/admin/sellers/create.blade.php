...
@section('main')
    <form action="/admin/sellers" method="post">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="birthday" placeholder="Enter seller birthday" name="birthday" id="birthday">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="Enter seller password" name="password" id="password">
        </div>
